...
This repository contains BETA source content for the upcoming *AWS SDK for C++ Developer Guide*. The
source code for the **AWS SDK for C++** is also on GitHub, at https://github.com/aws/aws-sdk-cpp/.
