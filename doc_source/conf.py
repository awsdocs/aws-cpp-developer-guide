...
project = u'AWS C++ Developer Guide'
...
htmlhelp_basename = 'AWSCPPDeveloperGuide'
...
latex_documents = [
  (master_doc, 'AWSCPPDeveloperGuide.tex', project,
   author, 'manual'),
]
...
man_pages = [
    (master_doc, 'awscppdeveloperguide', project, [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'AWSCPPDeveloperGuide', project,
   author, 'AWSCPPDeveloperGuide', 'One line description of project.',
   'Miscellaneous'),
]
